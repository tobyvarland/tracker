class CreateEntries < ActiveRecord::Migration[5.2]
  def change
    create_table :entries do |t|
      ...
      t.decimal :weight, default: nil, precision: 5, scale: 2
      t.decimal :calf_measurement, default: nil, precision: 5, scale: 2
      t.decimal :thigh_measurement, default: nil, precision: 5, scale: 2
      t.decimal :waist_measurement, default: nil, precision: 5, scale: 2
      t.decimal :stomach_measurement, default: nil, precision: 5, scale: 2
      t.decimal :shoulder_measurement, default: nil, precision: 5, scale: 2
      t.decimal :arm_measurement, default: nil, precision: 5, scale: 2
      t.decimal :neck_measurement, default: nil, precision: 5, scale: 2
